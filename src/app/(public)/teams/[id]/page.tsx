    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div>
        <div className="flex items-center gap-4 mb-8">
          ...
          <h2 className="text-2xl font-black text-white uppercase tracking-widest">Основний склад</h2>
        </div>
        ...
        <div className="space-y-12">
          {positionOrder.map((pos) => {
            ...
            return (
              <div key={pos}>
                <h3 className="text-sm font-black text-gray-500 uppercase tracking-widest mb-6 border-b border-gray-900 pb-3">
                  {pos === 'GK' ? 'Воротарі' : pos === 'DEF' ? 'Захисники' : pos === 'MID' ? 'Півзахисники' : 'Нападники'}
                </h3>
